...
export function CabeceraAdmin() {
    ...
    return (
        <header className="fixed top-0 right-0 left-64 h-16 flex justify-between items-center px-8 z-30 bg-[#0e0e11]/60 backdrop-blur-xl shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
